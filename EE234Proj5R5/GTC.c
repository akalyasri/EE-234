...
// half a second - 0x9EF21AB
// 1Hz - 0x13DE4355
void write_gtc_compare(void) {
	GTC_COMP0 = 0x9EF21AB; // 333333333 to compare value (counts to this value in approx. 1 sec)
}

void write_gtc_auto(void) {
	GTC_AI = 0x9EF21AB; // auto-increment by same amt, ~1s delay between interrupts
}
